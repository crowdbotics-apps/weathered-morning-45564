"""
Django settings for weathered_morning_45564 project.
...
ROOT_URLCONF = 'weathered_morning_45564.urls'
...
WSGI_APPLICATION = 'weathered_morning_45564.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_morning_45564 API",
    "DESCRIPTION": "API documentation for weathered_morning_45564 App",
    "VERSION": "v1",
}
